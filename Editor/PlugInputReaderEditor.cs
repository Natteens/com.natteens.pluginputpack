...
namespace PlugInputPack.Editor
{
    ...
    public class PlugInputReaderEditor : UnityEditor.Editor
    {
        ...
        private bool _showDevice = true, _showCursor = true, _showDebug = true, _showActions;
        ...
        private GUIStyle _sectionStyle, _foldoutStyle, _boldStyle, _labelStyle, _miniStyle, _btnPrimary, _btnSecondary;
        ...
        private void DrawAssetBlock()
        {
            ...
            EditorGUILayout.PropertyField(_inputActionAsset, new GUIContent("Asset", "The Unity Input System asset."));
        ...
        private void DrawStatusBlock()
        {
            ...
            if (reader.IsValid()) InfoBar(reader.GetDebugInfo(), OkGreen);
            else InfoBar("Assign a valid Input Action Asset with at least one action map.", WarnYellow);
        ...
        {
            EditorGUILayout.PropertyField(_lockCursorOnStart,       new GUIContent("Lock On Start",        "Lock and hide cursor on start."));
            EditorGUILayout.PropertyField(_autoLockCursorOnGamepad, new GUIContent("Auto Lock On Gamepad", "Auto lock/unlock cursor when switching to or from gamepad."));
        }
        ...
        private void AutoFind()
        {
            ...
            if (guids.Length == 0) { EditorUtility.DisplayDialog("Auto-find", "No InputActionAsset found.", "OK"); return; }
            if (guids.Length == 1)
            {
